...
import { Linkedin, Mail, Phone, Github, Download, X } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Open to software engineering internships, frontend roles, and
            ...
            return (
              <motion.a
                ...
                className="flex items-center gap-4 p-4 sm:p-5 
                           ...
                           rounded-xl hover:bg-sky-50 hover:border-sky-300 hover:shadow-lg
              ...
              >
                ...
                <motion.div
                  ...
                  className={`flex-shrink-0 p-3 rounded-lg bg-gradient-to-br ${contact.color} 
                             shadow-md shadow-sky-100 transition-shadow`}
                >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold text-slate-950 group-hover:text-sky-700 transition-colors">
                    {contact.label}
                  </h3>
                  <p className="text-sm sm:text-base text-slate-500 group-hover:text-slate-600 transition-colors truncate">
                    {contact.value}
                  </p>
                </div>
